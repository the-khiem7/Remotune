...
**[IMPLEMENTED]** Developers run `.\scripts\dev.ps1` for the native Windows loop. It uses the pinned Wails CLI directly, with frontend Vite hot reload and automatic relaunch after Go changes.
